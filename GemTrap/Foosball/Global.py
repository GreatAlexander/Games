...
BLUE1_START = (PITCH[0]*1/8 + EDGE, PITCH[1]*1/2 + EDGE)
BLUE2_START = (PITCH[0]*5/8 + EDGE, PITCH[1]*1/2 + EDGE)
RED1_START = (PITCH[0]*7/8 + EDGE, PITCH[1]*1/2 + EDGE)
RED2_START = (PITCH[0]*3/8 + EDGE, PITCH[1]*1/2 + EDGE)
